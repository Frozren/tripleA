...
public class BattleField extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (turn == 0) {
			...
			tour = h.RNG(2);
			if (tour==0) {message="<p>Saisir carte adverse � attaquer avec c1</p>"+message;def=0;}
	...
	public static void nextTurn() {
		...
		if(tour==0 && deckH.get(i).getLife()>0) {message="<p>Saisir carte adverse � attaquer avec c"+Integer.toString(i+1)+"</p>"+message;def=0;}
