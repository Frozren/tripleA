					...
					<div class="col-8">
						<div id="card">
							<input type="image" class="imgcard" idCard="${idCard1}"
								id="c${idCard1}" src="img/card/cardAP.png"
					...
					<div class="col-2">
						<div id="card">
							<input type="image" class="imgcard" idCard="${idCard2}"
								id="c${idCard2}" src="img/card/cardAB.png"
					...
					<div class="col-2">
						<div id="card">
							<input type="image" class="imgcard" idCard="${idCard4}"
								id="c${idCard4}" src="img/card/cardTG.png"
					...
					<div class="col-2">
						<div id="card">
							<input type="image" class="imgcard" idCard="${idCard3}"
								id="c${idCard3}" src="img/card/cardAV.png"
					...
					<div class="col-2">
						<div id="card">
							<input type="image" class="imgcard" idCard="${idCard5}"
								id="c${idCard5}" src="img/card/cardJR.png"
					...
					<div class="col-8">
						<div id="card">
							<input type="image" class="imgCard" idCard="${idCard6}"
								id="c${idCard6}" src="img/card/cardJA.png"
