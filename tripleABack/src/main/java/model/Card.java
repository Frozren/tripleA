...
public class Card {
	...
	public void isAttackedBy(Card c) {
		if (this.isProtection()) {
			...
			System.out.println("Cardatt" + c.getAtk() + " inflige " + (c.getAtk() - (c.getAtk() * 90) / 100) + "dgt � cardatt" + this.getAtk());
		} else {
			this.life -= (c.getAtk() - (c.getAtk() * this.def) / 100);
			System.out.println("Cardatt" + c.getAtk() + " inflige " + (c.getAtk() - (c.getAtk() * this.def) / 100) + "dgt � cardatt" + this.getAtk());
		}
	}
